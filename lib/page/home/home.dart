                    ...
                    child: SizedBox(
                        ...
                        child: Row(
                         ...
                         mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Image.asset("assets/icon/c.png",
                            height: 30,
                            ),
                            SizedBox(width: widthh*6/360,),
                     ...
                     Boxbesar(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                       padding:  EdgeInsets.only(left: widthh*24/360,top: heightt*24/910,bottom: heightt*8/910),
                       child: Text("Promo",
                                    style: GoogleFonts.inter(
                                      fontSize: 20,
                       ...
                       child: Text("Butuh Bantuan ?",
                        ...
                        Padding(
                          ...
                          child: InkWell(
                                      child: Container(                                       
                                        ...
                                        height: 120,
                                        decoration: BoxDecoration(
                                          image: DecorationImage(image: AssetImage("assets/image/Hotline.png",)
                                        ),
                        ...
                        SizedBox(height: heightt*24/910,)
                                ],
                  //  Container(
