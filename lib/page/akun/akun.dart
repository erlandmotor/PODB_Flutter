                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                         ...
                         Padding(
                           padding:  EdgeInsets.only(top: heightt*13/800,),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: GridView.builder(
                                  ...
                                  padding: EdgeInsets.only(top:heightt* 16/800,),
                                    ...
                                    child: Column(
                                      children: [
                                        if(namaTopup[index]=="Isi Saldo")...[
                                          ...
                                          TextIconModul(label: namaTopup[index].toString())
                                        ],
                                        if(namaTopup[index]=="Kirim Uang")...[
                                          BoxIconModul(icon: topUPProfil[index]),
                                          TextIconModul(label: namaTopup[index].toString())
                                ...
                                children: [
                                   Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                          Padding(
                                  padding:  EdgeInsets.only(left: widthh*16/360,top: heightt*16/800, bottom: heightt*8/800),
                        ...
                        Expanded(
                          child: PageView.builder(
                                ...
                                itemBuilder: (context, pagePosition) {
                                   ...
                                   InkWell(
                                     child: Container(
                                       margin: EdgeInsets.only(right: widthh*20/360),
                                       width: widthh,
                                       height:heightt* 140/800,
                                       decoration: BoxDecoration(
                                         image: DecorationImage(image: AssetImage(gambarRekomdasi[pagePosition]))
                                       ),
                                       )),
                                     ],
                                   );
                                  ...
                                  ListTile(
                                    ...
                                    leading: ShaderMask(
                                      ...
                                      child: Container(
                                       ...
                                       height: 24,
                                       decoration: BoxDecoration(
                                         image: DecorationImage(image: AssetImage("assets/icon/person.png"))
                                       ),
                                       )
                                  ),
                                  title: Transform.translate(
                                    offset: const Offset(-20, 0),
                                    child: const Text("Ubah Data Akun",
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 16
                                      ),
                                  ...
                                  trailing: Transform.translate(
                                    ...
                                    child: ShaderMask(
                                      ...
                                      child: Container(
                                       ...
                                       height: 24,
                                       decoration: BoxDecoration(
                                         image: DecorationImage(image: AssetImage("assets/icon/kanan.png"))
                                       ),
                                       )
                                      ),
                                    ),
                                    onTap: () {
                                       Navigator.push(context, MaterialPageRoute(builder: ((context) => EditAkun())));
                                    },
                                  ),
                                    ListTile(
                                    contentPadding: EdgeInsets.only(left: 30, right: 30),
                                    leading: ShaderMask(
                                      ...
                                      child: Container(
                                       ...
                                       height: 24,
                                       decoration: BoxDecoration(
                                         image: DecorationImage(image: AssetImage("assets/icon/lock.png"))
                                       ),
                                       )
                                  ),
                                  title: Transform.translate(
                           ...
                           SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ListTile(
                                      ...
                                      leading: ShaderMask(
                                       ...
                                       height: 24,
                                       decoration: BoxDecoration(
                                         image: DecorationImage(image: AssetImage("assets/icon/star.png"))
                                       ),
                                       )
                                  ),
                                  title: Transform.translate(
                                  ...
                                  trailing: Transform.translate(
                                    ...
                                    child: ShaderMask(
                                      ...
                                      leading: ShaderMask(
                                       ...
                                       height: 24,
                                       decoration: BoxDecoration(
                                         image: DecorationImage(image: AssetImage("assets/icon/doc.png"))
                                       ),
                                       )
                                    ),
                                    title: Transform.translate(
                                  ...
                                  ListTile(
                                    ...
                                    leading: ShaderMask(
                                      ...
                                      child: Container(
                                       ...
                                       height: 24,
                                       decoration: BoxDecoration(
                                         image: DecorationImage(image: AssetImage("assets/icon/logout.png"))
                                       ),
                                       )
                                  ),
                                  title: Transform.translate(
                                  ...
                                  trailing: Transform.translate(
                                    ...
                                    Padding(
                                      padding:  EdgeInsets.only(top: heightt*40/800),
                                      child: Container(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
