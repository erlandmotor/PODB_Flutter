...
class _RiwayatState extends State<Riwayat> {
 void initState() {
  ...
  List<DummyproFilter> 
  prod = [
    DummyproFilter(id: 1, name: "Urutkan", 
    pro: [
      DummyFilter(id: 1, name: "Terbaru",),
      DummyFilter(id: 2, name: "Terlama", ),
      DummyFilter(id: 3, name: "Harga Tertinggi", ),
      DummyFilter(id: 4, name: "Harga Terendah", )
    ]),

    DummyproFilter(id: 2, name: "Status",
     pro: [
      DummyFilter(id: 5, name: "Belum Bayar", ),
      DummyFilter(
          id: 6, name: "Berhasil"),
      DummyFilter(
          id: 7, name: "Dibatalkan", ),    
    ]),

    DummyproFilter(id: 3, name: "Kategori",
     pro: [
      DummyFilter(
          id: 8, name: "Telekomunikasi", ),
      DummyFilter(
          id: 9, name: "Tagihan", ),
           DummyFilter(
          id: 10, name: "Keuangan", ),
